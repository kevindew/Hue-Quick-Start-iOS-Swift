...
class BridgePushLinkViewController: UIViewController {
    ...
    func startPushLinking() {
        ...
        notificationManager.registerObject(
            self,
        ...
        notificationManager.registerObject(
            self,
            withSelector: "authenticationFailed",
    ...
    func authenticationFailed() {
        ...
        let error = PHError(
            domain: SDK_ERROR_DOMAIN,
            code: Int(PUSHLINK_TIME_LIMIT_REACHED.value),
    ...
    func noLocalConnection() {
        ...
        let error = PHError(
            domain: SDK_ERROR_DOMAIN,
            code: Int(PUSHLINK_NO_CONNECTION.value),
    ...
    func noLocalBridge() {
        ...
        let error = PHError(
            domain: SDK_ERROR_DOMAIN,
            code: Int(PUSHLINK_NO_LOCAL_BRIDGE.value),
            userInfo: [NSLocalizedDescriptionKey: "Authentication failed: No local bridge found."]
        )
